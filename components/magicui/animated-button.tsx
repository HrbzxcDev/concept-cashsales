...
>(
  (
    { checkStatus = false, onClick, className, children, ...props },
    ref,
  ) => {
    const [isSubscribed, setIsSubscribed] = useState<boolean>(checkStatus);
    ...
    if (
      ...
      throw new Error(
        "AnimatedButton expects two children, both of which must be <span> elements.",
      );
    }
